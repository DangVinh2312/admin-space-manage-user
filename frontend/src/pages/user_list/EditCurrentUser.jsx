...
export default class EditCurrentUser extends React.Component {
    constructor() {
        super();
        this.state = {
            username: "",
    ...
    handleSubmit = async (event) => {
        ...
        const addUser = await UserUtils.update(this.state);
        if (addUser){
    ...
    render() {
        return <>
            <h3><i className="fa fa-angle-right"></i> User Editting </h3>
